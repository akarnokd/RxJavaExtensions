...
import hu.akarnokd.rxjava4.functions.Consumer6;
 ...
 */
final class ActivePlan6<T1, T2, T3, T4, T5, T6> extends ActivePlan0 {
    private final Consumer6<T1, T2, T3, T4, T5, T6> onNext;
    ...
    ActivePlan6(
            ...
            Consumer6<T1, T2, T3, T4, T5, T6> onNext,
            Action onCompleted) {
        this.onNext = onNext;
