...
import hu.akarnokd.rxjava4.functions.Consumer9;
 ...
 */
final class Plan9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> extends Plan<R> {
    protected final Pattern9<T1, T2, T3, T4, T5, T6, T7, T8, T9> expression;
    protected final Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> selector;

    Plan9(Pattern9<T1, T2, T3, T4, T5, T6, T7, T8, T9> expression, Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> selector) {
    ...
    public ActivePlan0 activate(Map<Object, JoinObserver> externalSubscriptions,
        ...
        ActivePlan0 activePlan = new ActivePlan9<>(
                ...
                new Consumer9<T1, T2, T3, T4, T5, T6, T7, T8, T9>() {
                    @Override
                    public void accept(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8, T9 t9) {
                        R result;
                        try {
                            result = selector.apply(t1, t2, t3, t4, t5, t6, t7, t8, t9);
                        } catch (Throwable t) {
                            observer.onError(t);
                            return;
                        }
