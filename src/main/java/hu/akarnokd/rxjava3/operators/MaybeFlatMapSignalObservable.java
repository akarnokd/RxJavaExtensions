...
implements MaybeConverter<T, Observable<R>> {
    ...
    public Observable<R> apply(Maybe<T> t) {
        return new MaybeFlatMapSignalObservable<>(t, onSuccessHandler, onErrorHandler, onCompleteHandler);
    }
    ...
    implements MaybeObserver<T>, Disposable {
        ...
        public void onSuccess(T t) {
            ...
            try {
                next = Objects.requireNonNull(onSuccessHandler.apply(t), "The onSuccessHandler returned a null ObservableSource");
            } catch (Throwable ex) {
        ...
        public void onComplete() {
            ...
            try {
                next = Objects.requireNonNull(onCompleteHandler.get(), "The onCompleteHandler returned a null ObservableSource");
            } catch (Throwable ex) {
                Exceptions.throwIfFatal(ex);
                consumer.onError(ex);
                return;
        ...
        public void onError(Throwable e) {
            ...
            try {
                next = Objects.requireNonNull(onErrorHandler.apply(e), "The onErrorHandler returned a null ObservableSource");
            } catch (Throwable ex) {
                Exceptions.throwIfFatal(ex);
                consumer.onError(ex);
                return;
