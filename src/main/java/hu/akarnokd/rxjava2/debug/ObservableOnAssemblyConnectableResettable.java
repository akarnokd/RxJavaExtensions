 ...
 */
final class ObservableOnAssemblyConnectableResettable<T> extends ConnectableObservable<T>
implements ResettableConnectable {

    final ConnectableObservable<T> source;

    final RxJavaAssemblyException assembled;

    ObservableOnAssemblyConnectableResettable(ConnectableObservable<T> source) {
        this.source = source;
    ...
    public void resetIf(Disposable connection) {
        ((ResettableConnectable)source).resetIf(connection);
    }
}
