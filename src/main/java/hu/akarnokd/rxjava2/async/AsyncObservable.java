...
public final class AsyncObservable {
     ...
     */
    public static <T> Observable<T> start(Callable<? extends T> func) {
     ...
     */
    public static <T> Observable<T> start(Callable<? extends T> func, Scheduler scheduler) {
        return Observable.fromCallable(func).subscribeOn(scheduler).subscribeWith(AsyncSubject.<T>create());
    }
     ...
     */
    public static <R> Supplier<Observable<R>> toAsync(Callable<? extends R> func) {
    ...
    public static Supplier<Observable<Object>> toAsync(final Action action, final Scheduler scheduler) {
        return new Supplier<Observable<Object>>() {
            @Override
     ...
     * @see <a href="http://msdn.microsoft.com/en-us/library/hh229182.aspx">MSDN: Observable.ToAsync</a>
     */
    public static <R> Supplier<Observable<R>> toAsync(final Callable<? extends R> func, final Scheduler scheduler) {
        return new Supplier<Observable<R>>() {
            @Override
     ...
     */
    public static <T> Observable<T> startFuture(final Callable<? extends Future<? extends T>> functionAsync) {
        return RxJavaPlugins.onAssembly(new ObservableFromCallableNull<T>(new Callable<T>() {
            @Override
     ...
     * @see <a href="https://github.com/ReactiveX/RxJava/wiki/Async-Operators#wiki-startfuture">RxJava Wiki: startFuture()</a>
     */
    public static <T> Observable<T> startFuture(Callable<? extends Future<? extends T>> functionAsync,
        Scheduler scheduler) {
     ...
     */
    public static <T> Observable<T> deferFuture(Callable<? extends Future<? extends ObservableSource<? extends T>>> publisherFactoryAsync) {
    ...
    public static <T> Observable<T> deferFuture(
            final Callable<? extends Future<? extends ObservableSource<? extends T>>> publisherFactoryAsync,
            Scheduler scheduler) {
