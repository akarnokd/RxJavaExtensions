...
public class FlowableExpandTest {
    ...
    public void multipleRoots() {
        ...
        .test()
        .assertFailure(IOException.class, 10, 9)
        .assertError(TestHelper.assertErrorMessage("error"));
        ;
    }
    ...
    public void multipleRootsDelayError() {
        ...
        .test()
        .assertFailure(IOException.class, 10, 9, 5, 4, 3, 2, 1, 0)
        .assertError(TestHelper.assertErrorMessage("error"));
    }
    ...
    public void multipleRootsBreadth() {
        ...
        .test()
        .assertFailure(IOException.class, 10, 5, 9, 4)
        .assertError(TestHelper.assertErrorMessage("error"));
        ;
    }
    ...
    public void multipleRootsDelayErrorBreadth() {
        ...
        .test()
        .assertFailure(IOException.class, 10, 5, 9, 4, 3, 2, 1, 0)
        .assertError(TestHelper.assertErrorMessage("error"));
    }
}
