...
import hu.akarnokd.rxjava2.functions.FunctionTagging.FunctionTaggingException;
...
public class FunctionTaggingTest {
    ...
    @Test
    public void f1Tag() throws Exception {
    ...
    @Test
    public void f2Tag() throws Exception {
        boolean enabled = FunctionTagging.isEnabled();
        try {
            FunctionTagging.disable();
    ...
    @Test
    public void f3Tag() throws Exception {
        boolean enabled = FunctionTagging.isEnabled();
        try {
            FunctionTagging.disable();
            ...
            Function3<Integer, Integer, Integer, Integer> f = FunctionTagging.tagFunction3(new Function3<Integer, Integer, Integer, Integer>() {
                @Override
                public Integer apply(Integer a, Integer b, Integer c) throws Exception {
                    return a;
                }
            }, "Custom tag");
    ...
    @Test
    public void f4Tag() throws Exception {
        boolean enabled = FunctionTagging.isEnabled();
        try {
            FunctionTagging.disable();
            ...
            new Function4<Integer, Integer, Integer, Integer, Integer>() {
                @Override
                public Integer apply(Integer a, Integer b, Integer c, Integer d) throws Exception {
                    return a;
                }
            }, "Custom tag");
    ...
    @Test
    public void f5Tag() throws Exception {
        boolean enabled = FunctionTagging.isEnabled();
        try {
            FunctionTagging.disable();
    ...
    @Test
    public void f6Tag() throws Exception {
        boolean enabled = FunctionTagging.isEnabled();
        try {
    ...
    @Test
    public void f7Tag() throws Exception {
        boolean enabled = FunctionTagging.isEnabled();
        try {
    ...
    @Test
    public void f8Tag() throws Exception {
        boolean enabled = FunctionTagging.isEnabled();
        try {
    ...
    Function9<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> {
        ...
        @Override
        public Integer apply(Integer t1, Integer t2, Integer t3, Integer t4,
                Integer t5, Integer t6, Integer t7) throws Exception {
            if (crash) {
                throw new IOException();
            }
            if (returnNull) {
        ...
        @Override
        public Integer apply(Integer t1, Integer t2, Integer t3, Integer t4,
                Integer t5, Integer t6) throws Exception {
            if (crash) {
                throw new IOException();
            }
            if (returnNull) {
