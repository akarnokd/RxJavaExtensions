...
public class PerhapsTest implements Consumer<Object>, Action, LongConsumer, Cancellable {
    ...
    public void errorSupplier() {
        Perhaps.error(new Callable<Throwable>() {
            @Override
    ...
    @Test
    public void defer() {
        Perhaps<Integer> sp = Perhaps.defer(new Callable<Perhaps<Integer>>() {
            int i;

            @Override
            public Perhaps<Integer> call() throws Exception {
    ...
    public void usingEager() {
        Perhaps.using(Functions.justCallable(1),
    ...
    public void flatMapSignal() {
        Perhaps.just(1).flatMap(
                ...
                Functions.justCallable(Perhaps.just(4))
        )
        .test()
        .assertResult(2);
    }
    ...
    public void retryInfinite() {
        ...
        Perhaps.defer(new Callable<Perhaps<Integer>>() {
            @Override
            public Perhaps<Integer> call() throws Exception {
                if (++counter[0] == 5) {
